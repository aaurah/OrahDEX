...
- [LiquidityBot concurrent cycle bug](liquidity-bot-cycle-bug.md) — unguarded first runCycle() outside guardedInterval causes stacking cycles and pool exhaustion; fix via initialDelayMs.
