 ...
 *
 * Usage (from repo root, after `cd worker && pnpm install`):
 *   DATABASE_URL=postgres://... node scripts/migrate.mjs [./worker/migrations]
 *
...
const dir = resolve(process.argv[2] ?? join(process.cwd(), "worker", "migrations"));
