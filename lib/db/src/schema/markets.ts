...
export const marketsTable = pgTable("markets", {
  ...
  lastPrice: numeric("last_price", { precision: 20, scale: 8 }).notNull().default("0"),
  ...
  volume24h: numeric("volume_24h", { precision: 30, scale: 8 }).notNull().default("0"),
  high24h: numeric("high_24h", { precision: 20, scale: 8 }).notNull().default("0"),
  low24h: numeric("low_24h", { precision: 20, scale: 8 }).notNull().default("0"),
  marketCap: numeric("market_cap", { precision: 30, scale: 2 }),
  status: text("status").notNull().default("active"),
  type: text("type").notNull().default("spot"),
  minOrderSize: numeric("min_order_size", { precision: 20, scale: 8 }).notNull().default("0.00000001"),
  maxOrderSize: numeric("max_order_size", { precision: 20, scale: 8 }).notNull().default("1000000"),
