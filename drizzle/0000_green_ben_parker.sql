...
CREATE TABLE "quantum_keys" (
	...
	"algorithm" text DEFAULT 'dilithium2' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "lp_positions" (
	...
	"amount" numeric(36, 18) NOT NULL,
	"apy" numeric(10, 4) NOT NULL,
	"lock_days" text DEFAULT '0' NOT NULL,
	"status" text DEFAULT 'active' NOT NULL,
	"reward_accrued" numeric(36, 18) DEFAULT '0',
	"started_at" timestamp DEFAULT now() NOT NULL,
	"unlocks_at" timestamp NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "bsv_intent_sessions" (
	"id" text PRIMARY KEY NOT NULL,
	"intent_hash" text NOT NULL,
	"nonce" text NOT NULL,
	"user_address" text NOT NULL,
	"solver_address" text,
	"token_in" text DEFAULT 'BSV' NOT NULL,
	"token_out" text NOT NULL,
	...
	"deadline_blocks" integer NOT NULL,
	"secret" text NOT NULL,
	"secret_hash" text NOT NULL,
	"redeem_script" text NOT NULL,
	"htlc_address" text NOT NULL,
	...
	"funding_confirmed" boolean DEFAULT false NOT NULL,
	"confirmations" integer DEFAULT 0 NOT NULL,
	"solver_payment_txid" text,
	"fill_note" text,
	"claim_txid" text,
	"refund_txid" text,
	"audit_txid" text,
...
CREATE TABLE "iceberg_orders" (
	...
	"side" text NOT NULL,
	"price" numeric(36, 18) NOT NULL,
	"total_quantity" numeric(36, 18) NOT NULL,
	"filled_quantity" numeric(36, 18) DEFAULT '0' NOT NULL,
	"visible_quantity" numeric(36, 18) NOT NULL,
...
CREATE TABLE "oco_orders" (
	...
	"stop_price" numeric(36, 18) NOT NULL,
...
CREATE TABLE "trailing_stop_orders" (
	...
	"side" text NOT NULL,
	"quantity" numeric(36, 18) NOT NULL,
	"trail_percent" numeric(10, 4) NOT NULL,
	"activation_price" numeric(36, 18),
	"current_stop_price" numeric(36, 18) NOT NULL,
	"high_watermark" numeric(36, 18) NOT NULL,
	"low_watermark" numeric(36, 18) NOT NULL,
	"status" text DEFAULT 'active' NOT NULL,
...
CREATE TABLE "twap_orders" (
	...
	"completed_slices" integer DEFAULT 0 NOT NULL,
	"interval_seconds" integer NOT NULL,
	"start_at" timestamp NOT NULL,
	"end_at" timestamp NOT NULL,
	"max_slippage_percent" numeric(10, 4) DEFAULT '1.0' NOT NULL,
...
CREATE TABLE "options_contracts" (
	...
	"gamma" numeric(10, 6) NOT NULL,
	"theta" numeric(10, 6) NOT NULL,
	"vega" numeric(10, 6) NOT NULL,
...
CREATE TABLE "options_positions" (
	...
	"unrealized_pnl" numeric(20, 8) DEFAULT '0' NOT NULL,
	"realized_pnl" numeric(20, 8) DEFAULT '0' NOT NULL,
	"collateral" numeric(20, 8) DEFAULT '0' NOT NULL,
	"status" text DEFAULT 'open' NOT NULL,
...
CREATE TABLE "funding_rates" (
	...
	"premium" numeric(20, 10) NOT NULL,
	"next_funding_at" timestamp NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE INDEX "orders_chain_status_idx" ON "orders" USING btree ("chain_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "orders_wallet_nonce_uidx" ON "orders" USING btree (lower("wallet_address"),"nonce");--> statement-breakpoint
...
CREATE UNIQUE INDEX "quantum_keys_wallet_uidx" ON "quantum_keys" USING btree ("wallet_address");--> statement-breakpoint
...
CREATE INDEX "staking_positions_coin_idx" ON "staking_positions" USING btree ("coin");--> statement-breakpoint
CREATE INDEX "lp_pos_wallet_idx" ON "lp_positions" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "lp_pos_status_idx" ON "lp_positions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "lp_pos_pool_idx" ON "lp_positions" USING btree ("pool");--> statement-breakpoint
CREATE UNIQUE INDEX "bsv_intent_hash_idx" ON "bsv_intent_sessions" USING btree ("intent_hash");--> statement-breakpoint
CREATE UNIQUE INDEX "bsv_intent_nonce_user_idx" ON "bsv_intent_sessions" USING btree ("user_address","nonce");--> statement-breakpoint
CREATE INDEX "bsv_intent_status_idx" ON "bsv_intent_sessions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "bsv_intent_user_idx" ON "bsv_intent_sessions" USING btree ("user_address");--> statement-breakpoint
CREATE INDEX "bsv_intent_solver_idx" ON "bsv_intent_sessions" USING btree ("solver_address");--> statement-breakpoint
CREATE INDEX "bsv_intent_htlc_addr_idx" ON "bsv_intent_sessions" USING btree ("htlc_address");--> statement-breakpoint
CREATE INDEX "bsv_intent_expires_idx" ON "bsv_intent_sessions" USING btree ("expires_at");--> statement-breakpoint
CREATE INDEX "bsv_intent_terminal_idx" ON "bsv_intent_sessions" USING btree ("terminal_at");--> statement-breakpoint
CREATE INDEX "iceberg_orders_wallet_idx" ON "iceberg_orders" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "iceberg_orders_status_idx" ON "iceberg_orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "oco_orders_wallet_idx" ON "oco_orders" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "oco_orders_status_idx" ON "oco_orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "trailing_stop_wallet_idx" ON "trailing_stop_orders" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "trailing_stop_status_idx" ON "trailing_stop_orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "twap_orders_wallet_idx" ON "twap_orders" USING btree ("wallet_address");--> statement-breakpoint
CREATE INDEX "twap_orders_status_idx" ON "twap_orders" USING btree ("status");--> statement-breakpoint
CREATE INDEX "options_contracts_underlying_expiry_status_idx" ON "options_contracts" USING btree ("underlying_symbol","expiry","status");--> statement-breakpoint
CREATE INDEX "options_positions_wallet_status_idx" ON "options_positions" USING btree ("wallet_address","status");--> statement-breakpoint
CREATE INDEX "funding_payments_wallet_settled_idx" ON "funding_payments" USING btree ("wallet_address","settled_at");--> statement-breakpoint
CREATE INDEX "funding_rates_symbol_idx" ON "funding_rates" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "funding_rates_symbol_created_idx" ON "funding_rates" USING btree ("symbol","created_at");