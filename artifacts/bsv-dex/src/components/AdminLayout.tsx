...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/admin/profits",      label: "All Profits",     icon: TrendingUp, badge: "NEW", badgeColor: "bg-primary/15 text-primary border-primary/25" },
  ...
  {
    title: "Users", icon: Users, color: "text-blue-400",
    items: [
