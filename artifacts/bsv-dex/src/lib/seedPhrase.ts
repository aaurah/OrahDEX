/**
 * OrahDEX HD Wallet — BIP39 + BIP44 multi-chain derivation (browser-safe).
 *
 * One seed phrase → four chain addresses:
 *   EVM (Ethereum, BSC, Polygon…) : m/44'/60'/0'/0/0
 *   BTC (Bitcoin)                 : m/44'/0'/0'/0/0
 *   BCH (Bitcoin Cash)            : m/44'/145'/0'/0/0  → CashAddr
 *   BSV (Bitcoin SV)              : m/44'/236'/0'/0/0
 *
 * All addresses are fully compatible with MetaMask, Trust Wallet, Ledger, etc.
 */
