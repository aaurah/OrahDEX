      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center flex-wrap gap-2 sm:justify-end">
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl border border-border hover:border-orange-400/40 text-xs font-semibold text-muted-foreground hover:text-orange-400 transition-all whitespace-nowrap"
          >
          ...
          <button
            ...
            className={cn(
              "flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold transition-all whitespace-nowrap",
              isDirty
