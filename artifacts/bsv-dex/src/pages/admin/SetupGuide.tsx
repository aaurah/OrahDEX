...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: "Configure SMTP to send user emails — KYC approvals, withdrawal confirmations, login alerts, and newsletters.",
    href: "/admin/integrations", icon: Mail, priority: "recommended",
    checkIntegrations: ["smtp_host", "smtp_user"],
  },
  {
    id: "fees",         step: 5,  label: "E",
    title: "Trading Fees",
