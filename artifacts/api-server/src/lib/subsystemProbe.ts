...
const EVM_CHAINS: Array<{ id: string; label: string; envVar: string; fallback: string }> = [
  { id: "eth",      label: "Ethereum Mainnet",  envVar: "ETH_RPC_URL",      fallback: "https://cloudflare-eth.com" },
  ...
  { id: "polygon",  label: "Polygon",            envVar: "POLYGON_RPC_URL",  fallback: "https://rpc.ankr.com/polygon" },
