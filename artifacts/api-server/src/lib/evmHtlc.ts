...
export const EVM_CHAINS: Record<number, ChainConfig> = {
  ...
  25: {
    ...
    usdtAddress:     "0x66e428c3f67a68878562e79A0234c1F83c208770" as Address,
    usdcAddress:     "0xc21223249CA28397B4B6541dfFaEcC539BfF0c59" as Address,
  },
  100: {
    chainId:         100,
    name:            "Gnosis",
    ...
    usdtAddress:     "0x4ECaBa5870353805a9F068101A40E0f32ed605C6" as Address,
    usdcAddress:     "0xDDAfbb505ad214D7b80b1f830fcCc89B60fb7A83" as Address,
  },
  146: {
    chainId:         146,
    name:            "Sonic",
  ...
  250: {
    ...
    usdtAddress:     "0x049d68029688eAbF473097a2fC38ef61633A3C7A" as Address,
    usdcAddress:     "0x04068DA6C83AFCFA0e13ba15A6696662335D5B75" as Address,
  },
  288: {
    chainId:         288,
    name:            "Boba Network",
    ...
    usdtAddress:     "0x5DE1677344D3Cb0D7D465c10b72A8f60699C062d" as Address,
    usdcAddress:     "0x66a2A913e447d6b4BF33EFbec43aAeF87890FBbc" as Address,
  },
  1088: {
    chainId:         1088,
    name:            "Metis",
    rpcUrl:          process.env.METIS_RPC_URL ?? "https://andromeda.metis.io/?owner=1088",
    contractAddress: DEPLOYED_CONTRACT,
    nativeSymbol:    "METIS",
    blockExplorer:   "https://andromeda-explorer.metis.io",
    usdtAddress:     "0xbB06DCA3AE6887fAbF931640f67cab3e3a16F4dC" as Address,
  ...
  1284: {
    ...
    usdtAddress:     "0xeFAeeE334F0Fd1712f9a8cc375f427D9Cdd40d73" as Address,
    usdcAddress:     "0x818ec0A7Fe18Ff94269904fCED6AE3DaE6d6dC0e" as Address,
  },
  5000: {
    chainId:         5000,
    name:            "Mantle",
    ...
    usdtAddress:     "0x201EBa5CC46D216Ce6DC03F6a759e8E766e956aE" as Address,
    usdcAddress:     null,
  },
  34443: {
    chainId:         34443,
    ...
    usdtAddress:     null,
    usdcAddress:     "0xd988097fb8612cc24eeC14542bC03424c656005f" as Address,
  },
  42220: {
    chainId:         42220,
    name:            "Celo",
    ...
    usdtAddress:     "0x88eeC49252c8cbc039DCdB394c0c2BA2f1637EA0" as Address,
  ...
  167000: {
    ...
    usdtAddress:     null,
    usdcAddress:     "0x07d83526730c7438048D55A4fc0b850e2aaB6f0b" as Address,
  },
  11155111: {
    chainId:         11155111,
    name:            "Sepolia",
