...
// OrahDEXEscrow deployed address — same contract on all supported mainnet chains.
const ORAHDEX_ESCROW = "0xeE234cEb85697b64800E696699b7841e00413B4f" as Address;
...
export const EVM_CHAINS: Record<number, ChainConfig> = {
  1: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_ETH ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  137: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_POLYGON ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "MATIC",
  ...
  56: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_BSC ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "BNB",
  ...
  8453: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_BASE ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  42161: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_ARB ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  10: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_OP ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  43114: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_AVAX ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "AVAX",
  ...
  324: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_ZKSYNC ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  59144: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_LINEA ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  534352: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_SCROLL ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  1329: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_SEI ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "SEI",
  ...
  130: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_UNICHAIN ?? ORAHDEX_ESCROW) as Address | null,
    nativeSymbol:    "ETH",
  ...
  11155111: {
    ...
    contractAddress: (process.env.EVM_HTLC_CONTRACT_SEPOLIA ?? "0x4deb6023abD9E1C640aDa35201be8ff591d21cF2") as Address | null,
    nativeSymbol:    "ETH",
