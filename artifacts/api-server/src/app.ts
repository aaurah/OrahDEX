 ...
 * Skipped inside Cloudflare Workers (ORAHDEX_RUNTIME=worker): workerd's
 * zlib streaming corrupts gzip bodies, and Cloudflare's edge already
 * compresses responses automatically. */
if (process.env.ORAHDEX_RUNTIME !== "worker") {
  app.use(compression({
    level: 6,
    threshold: 512,
